            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <table class="layui-table" id="userList">
                        <tr>
                            <th lay-data="{width:60, sort: true}">ID</th>
                            <th lay-data="{width:60, sort: true}">房间号</th>
                            <th lay-data="{minWidth: 60}">可住人数</th>
                            <th lay-data="{width:60,templet: '#switchTpl'}">价格</th>
    ...
    $(function() {
        $.ajax({
            ...
            success:function (data) {
                console.log(data)
                if (data.code === 200 && data.house != null ) {
                    // 获取成功
                    layer.msg(data.message, {icon: 1, time: 3000});
                    let houses = data.house;
                    for (const n of houses) {
                        let list = "<tr>" +
                            ...
                            "<td>" + n.state + "</td>" +
                            "<td>" + n.customerId + "</td>" +
                             " <td><a  class='btn btn-primary' href='#'>编辑</a> <a class='btn btn-danger' href='#'>删除</a></td>"+
                            "</tr>";
